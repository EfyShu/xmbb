...
import com.efy.listener.impl.ButtonListener;
...
//				System.out.println(info.getName());
	...
	public static Console getInstance(int initWidth,int initHeight){
		...
		cons.setWidth(initWidth);
		cons.setHeight(initHeight);
		System.setOut(out); 
		System.setErr(err);
		return cons;
	}
	...
	public static void main(String[] args) {
		Console.getInstance(1366,733).initComponents("得意生活刷帖器",new String[][]{},new String[][]{},JFrame.EXIT_ON_CLOSE);
	}
}
